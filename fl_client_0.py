...
if __name__ == "__main__":
    ...
    train_ids = ['2_10', '2_11', '3_10', '3_11', '6_10', '6_11']
    # test_ids = ['5', '21', '15', '30']
    ...
    for gfl_model in gfl_models:
        ...
        train_strategy = TrainStrategy(optimizer=optimizer, scheduler=scheduler, batch_size=10, loss_function=CrossEntropy2d, accuracy_function=accuracy,test_function=test)
